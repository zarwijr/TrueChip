module secure_soc_top #(
    ...
    input  wire        CLOCK_50,
    inout  wire [35:0] GPIO,       // Khai báo mảng GPIO chuẩn của DE10-Standard
    ...
    // --- GÁN TÍN HIỆU UART VÀO GPIO ---
    wire UART_RXD = GPIO[0];       // Nhận dữ liệu (RX) từ GPIO[0]
    wire UART_TXD;                 // Khai báo wire nội bộ cho TX
    assign GPIO[1] = UART_TXD;     // Xuất dữ liệu (TX) ra GPIO[1]
    
    // Đặt các chân GPIO còn lại ở trạng thái trở kháng cao (High-Z) để an toàn
